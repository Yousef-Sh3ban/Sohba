          ...
          FilledButton(
            onPressed: () async {
              ...
              if (newName.isNotEmpty && newName.length >= 2) {
                ...
                // تحديث في Firebase (ملف المستخدم)
                await AppServices.instance.userRepository.updateUserName(
                  userId,
                  newName,
                );

                // تحديث في Firebase (جميع المجموعات)
                await AppServices.instance.groupRepository
                    .updateMemberNameInAllGroups(
                      userId: userId,
                      newName: newName,
                    );

...
class TaskRepository {
  ...
  /// 
  /// [previousStatus] هي الحالة السابقة المعروفة من الـ client لضمان
  /// حساب الفرق الصحيح وتجنب race conditions.
  Future<void> updateTaskCompletion({
    ...
    TaskStatus previousStatus = TaskStatus.none,
  }) async {
    try {
      ...
      // حساب الفرق بناءً على الحالة السابقة المعروفة من الـ client
      final oldPoints = _calcPoints(previousStatus.value, taskPoints);

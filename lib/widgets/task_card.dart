...
import '../models/task_completion_model.dart'; // TaskStatus
...
class TaskCard extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                // ─────────────────────────────────────────────────────────────
                _buildPointsBadge(theme),
                const SizedBox(width: 12),

                // ─────────────────────────────────────────────────────────────
                // Checkbox ثلاثي الحالات (فارغ / جزئي / مكتمل)
                // ─────────────────────────────────────────────────────────────
                _buildCheckbox(isCompleted, isPartial, theme),
              ],
            ),
          ),
        ),
  ...
  /// بناء أيقونة المهمة
  Widget _buildIcon(TaskIconData iconData, ThemeData theme) {
    return Container(
      width: 50,
      height: 50,
      decoration: BoxDecoration(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: theme
                  .colorScheme
                  .onTertiaryContainer, // لون مناسب للخلفية الذهبية
            ),
          ),
  ...
  Widget _buildCheckbox(bool isCompleted, bool isPartial, ThemeData theme) {
